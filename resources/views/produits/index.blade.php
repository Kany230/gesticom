                        ...
                        <tbody>
                            @foreach ($produit as $produits)
                                ...
                                @if ($produits->stock <= 10)
                                   <tr>
                                      <td colspan="3" style="background-color: #f8d7da; color: #721c24; font-weight: bold; text-align: center;">
                                        <strong>ALERTE: </strong>Le produit {{$produits->nom_articles}} a atteint une quantite de 10
                                      </td>
                                   </tr>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>Nom du produit</th>
                                <th>Stock</th>
                                <th>Nombre d'achat du produit</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($produit as $produits)
